			...
			<li><a href="contactus.html">Contact Us</a>
			  <ul>
				...
				<div id="feedBackContainer">
					<button id="feedBackButton" class="feedBackButtonRight" onclick="showRecaptcha();">FeedBack</button>
							...
							<form method="POST" action="feedback.php">
								<fieldset class="ui-dialog-content ui-widget-content ui-corner-all">
								  ...
								  <div id="feedBackTextFName" class="floatLeft">
									  ...
									  <input type="text" name="myFName" id="myFName" required="required" class="ui-state-default ui-corner-all">
								  </div>
								  <div id="feedBackTextLName" class="floatRight">
									  <label for="myLName">Last Name:</label>
									  <input type="text" name="myLName" id="myLName" required="required" class="ui-state-default ui-corner-all">
								  </div>
								  <div id="feedBackTextEmail" class="clear floatLeft">
									  <label for="myEmail">E-mail:</label>
									  <input type="email" name="myEmail" id="myEmail" required="required" class="ui-state-default ui-corner-all">
								  </div>
								  <div id="feedBackTextPhone" class="floatRight">
									  <label for="myPhone">Phone:</label>
									  <input type="tel" name="myPhone" id="myPhone" class="ui-state-default ui-corner-all">
								  </div>
								  <div id="feedBackTextComment" class="clear">
									  <label for="myComments">Comments:</label>
									  <textarea name="myComments" id="myComments" rows="2" cols="40" class="ui-state-default ui-corner-all"></textarea>
								  </div>
								  <div id="human">
									   <?php
